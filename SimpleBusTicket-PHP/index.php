...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">KBTBS</a>
            ...
            <div>
                ...
                <a href="#pnr-enquiry" class="pnr nav-item">PNR Qn</a>
            </div>
        </nav>
    </header>
    <!-- Login Modal -->
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Kimathi Bus Ticket Booking System</h1>

            <p class="text-center">Welcome to KImathi Bus Ticket Booking System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                Kimathi Bus Station is located adjacent to the Kimathi post office and the former District Office Headquarters, serves as a central hub for various transportation services within the area.
                 It hosts multiple terminals facilitating travel to neighboring towns such as Nyeri, Nakuru, and Meru, as well as to smaller satellite towns.
                  To streamline operations and ensure a steady income flow among investors, many vehicle owners have leased their buses and matatus to different cooperative societies (Saccos).
                  Its aimed to provide efficient and flexible transportation to clients within Kimathi.
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Kimathi Bus Ticket Booking System
                        </p>
        </footer>
    </div>
