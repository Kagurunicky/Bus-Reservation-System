<style>
    ...
    *, *::after, *::before{
    ...
    #home{
        height: 70vh;
        background-image: url("https://i.pinimg.com/originals/a9/ee/6a/a9ee6a232ab0aca934216ae79f60aacf.jpg");
    ...
    #user{
        height: 70vh;
        background-image: url("../img/sbtbsimg.png");
        background-size: cover;
        background-position: 0% 65%;;
        position: relative;
        display: flex;
    ...
    #pnr-enquiry{
        height: 80vh;
        background-image: url("https://banner2.cleanpng.com/20230423/rli/transparent-cartoon-bus-eco-bus-green-bus-world-car-free-day-1711148190149.webp");
        background-size: cover;
